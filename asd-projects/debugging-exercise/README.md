...
- You should now see one ghost moving to the left side of the screen.

<br><br><br><br>

# TODO 3: Get the Ghosts Moving

🎯 **Goal:** Use the Chrome debugger to step through the program and discover why the ghosts aren't all moving.
...
6. Notice that `maxGhosts` becomes `1` — this is the source of the issue. Now your task is to **track where that value is changed**.
...
> ⚠️ **Heads up:**  
> If you accidentally step into jQuery or external code, either hit the **Step Out** button, click the **Resume** button, or refresh the page and resume stepping again — you're only interested in _your_ code.
